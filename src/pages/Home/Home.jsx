...
export default function Home() {
    ...
    if (city == 'venice') {
        data = {
            title: "Venice",
            bg: '/cityGuide-react/veniceBg.jpg',
            ...
            images: ['/cityGuide-react/venice1.jpg', '/cityGuide-react/venice2.jpg', '/cityGuide-react/venice3.jpg', '/cityGuide-react/venice4.jpg'],
        ...
        data = {
            title: 'Warsaw',
            bg: '/cityGuide-react/warsawBg.jpg',
            ...
            images: ['/cityGuide-react/warsaw1.jpg', '/cityGuide-react/warsaw2.jpg', '/cityGuide-react/warsaw3.jpg', '/cityGuide-react/warsaw4.jpg'],
            ...
            <div className={styles.main}>
                <div className={styles.main__container}>
                    ...
                    <div className={styles.main__slider}>
                        <div className='main__line' style={styleLine} ref={line}>
                            <div className={styles.main__img} ref={image}>
                                <img src={data.images[0]} id="img" alt="" loading="lazy" />
                            </div>
                            <div className={styles.main__img}>
                                <img src={data.images[1]} id="img" alt="" loading="lazy" />
                            </div>
                            <div className={styles.main__img}>
                                <img src={data.images[2]} id="img" alt="" loading="lazy" />
                            </div>
                            <div className={styles.main__img}>
                                <img src={data.images[3]} id="img" alt="" loading="lazy" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className={styles.info__row}>
                        ...
                        <div className={styles.info__text}>
                            ...
                            <div className={styles.info__btn}>
                                <Link to={`/cityGuide-react/attractions/${city}`}><a>Достопримечательности</a></Link>
                            </div>
                        </div>
                    </div>
                </div>
